...
document.getElementById("botonAñadir").addEventListener("click", function (event) {
    ...
    if (productoAñadir == '' || valorAñadir == '' || categoriaAñadir == '' || existenciaAñadir == '' || imagenAñadir == '') {
...
window.addEventListener("load", () => {
    ...
    for (let i = 0; i < productos.length; i++) {
        ...
        <div class="contenedorProductos">
            ...
            <p class="categoria">Categoria: ${productos[i].categoria}</p>
            <p class="precio"><span>Precio: $ ${productos[i].valor} Dollars</span></p> 
